...
export default function MobileChatDrawer({
    ...
    return (
        <div className="absolute inset-0 z-40 lg:hidden">
            ...
            <div className="relative h-full w-[22rem] border-r border-slate-800/80 bg-slate-950/95 p-4">
                <div className="mb-4 flex items-center justify-between rounded-2xl surface-card--elevated p-3">
                    <div>
                ...
                <div className="flex h-[calc(100%-5.5rem)] flex-col gap-3">
                    <ChatRailContent
                        sessions={sessions}
